                                            ...
                                            @foreach ($post as $index => $item)
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div class="dropdown" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" style="min-width: 100%;" aria-labelledby="dropdownMenuButton">
                                                          <a class="dropdown-item" onclick="artipostDelete{{ $item->id }}({{ $item->id }})">Delete</a>
                                                        </div>
                                                      </div>
                                                      @endif
                                                      @endauth
                                                        ...
                                                        <tfoot style="text-align:center;">
                                                            <tr style="border-top:2px solid #239B56 ">
                                                                <th colspan="2" @auth
                                                                    ...
                                                                    @endauth>
                                                                    <input type="hidden" id="post{{ $item->id }}"
                                                                        value="{{ $item->id }}">
                                            ...
                                            @foreach ($gallery as $item)
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="dropdown" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" style="min-width: 100%;" aria-labelledby="dropdownMenuButton">
                                                          <a class="dropdown-item" onclick="user_galleryDelete{{ $item->id }}({{ $item->id }})">Delete</a>
                                                        </div>
                                                      </div>
                                                      @endif
                                                      @endauth
                                            ...
                                            @foreach ($videos as $item)
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="dropdown" style="float: right;">
                                                        ...
                                                        <div class="dropdown-menu" style="min-width: 100%;" aria-labelledby="dropdownMenuButton">
                                                          <a class="dropdown-item" onclick="user_videoDelete{{ $item->id }}({{ $item->id }})">Delete</a>
                                                        </div>
                                                      </div>
                                                      @endif
                                                      @endauth
                                            ...
                                            @if (Auth()->user()->id != $arti->id && $rating->where('user_id',Auth()->user()->id)->count() ==0 )
                                                ...
                                                <form action="{{ route('Rating') }}" class="review-form"
                                                    ...
                                                    <div class="container">
                                                        <div class="feedback">
                                                          <div class="rating">
                                                            <input type="radio" name="rate" value="5" checked id="rating-5">
