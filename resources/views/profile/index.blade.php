                            ...
                            <div class="form-group">
                                ...
                                <select name="district_id" class="form-control select2" id="district-dropdown">
                                    @foreach ($district as $item)
                                        <option value="{{ $item->id }}" @if($user->district_id==$item->id) selected @endif>{{ $item->name ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="tehsil_id" class="form-control select2" id="district-dropdown">
                                    @foreach ($tehsil as $item)
                                        <option value="{{ $item->id }}" @if($user->tehsil_id==$item->id) selected @endif>{{ $item->name ?? '' }}({{$item->district_name->name??''}})</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
