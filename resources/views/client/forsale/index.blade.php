...
@section('content')
    @can('forsale_product_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('client.forsale.create') }}">
                    Add New
                </a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @can('forsale_product_edit')
                                        <a class="btn btn-xs btn-info" href="{{ route('client.forsale.edit', $item->id) }}">
                                            Edit
                                        </a>
                                    @endcan
...
<script>
    function productDelete{{$item->id}}(id){
        swal({
            ...
            if (willDelete) {
                var url = '{{ route("client.deleteForsale", ":id") }}';
