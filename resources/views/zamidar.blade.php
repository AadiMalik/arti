                ...
                <div class="breadcrumb-wrap">
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Zamidar Products</li>
                        </ul>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="product-item fix mb-30">
                                <div class="product-thumb">
                                    <a href="{{url('forsale-detail/'.$item->id)}}">
                                        @foreach ($sale_product_image->where('other_id',$item->id)->take(2) as $loop=> $item2)
                                        @if($loop->first)
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="product-list-item mb-30">
                                ...
                                <div class="product-list-content">
                                    <h3><a href="{{url('forsale-detail/'.$item->id)}}">{{$item->name??''}}({{$item->type??''}})</a></h3>
                                    {{-- <div class="ratings">
                                        <span class="good"><i class="fa fa-star"></i></span>
                                        <span class="good"><i class="fa fa-star"></i></span>
                                        <span class="good"><i class="fa fa-star"></i></span>
