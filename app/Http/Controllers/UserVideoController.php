...
class UserVideoController extends Controller
{
    ...
    {
        $user_video = UserVideo::where('user_id', Auth()->user()->id)->get();
        return view('client/user_video.index', compact('user_video'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $user_video->save();
        return redirect('user-video')->with('success', 'Video has created!');
    }
