...
class OtherProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin/forsale.index',compact('product'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $productImage->user_id = Auth()->user()->id;
        $productImage1->save();
        return redirect('admin/forsale')->with('success','For Sale Product has created!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/forsale.edit',compact('product'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->update();
        return redirect('admin/forsale')->with('success','For Sale Product has updated!');
    }
